<?php namespace App\Http\Controllers;
	...
	class AdminIklanController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->col[] = ["label"=>"Created By","name"=>"created_by_priv","join"=>"cms_privileges,name"];
			...
			$this->form[] = ['label'=>'Created By','name'=>'created_by_priv','type'=>'hidden','width'=>'col-sm-3',"value"=>CRUDBooster::myPrivilegeId()];
	    ...
	    */
	    public function hook_query_index(&$query) {
	        ...
	        if(CRUDBooster::myPrivilegeId()!=1){
	            $query->where('created_by_priv',CRUDBooster::myPrivilegeId());
	        }
	    }
