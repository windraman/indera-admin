<?php namespace App\Http\Controllers;
	...
	class AdminModulsController extends \crocodicstudio\crudbooster\controllers\CBController {
		...
		$this->col[] = array("label"=>"Owner","name"=>"owner" );
		$this->col[] = array("label"=>"Latitude","name"=>"latitude" );
		$this->col[] = array("label"=>"Longitude","name"=>"longitude" );
		$this->col[] = array("label"=>"Local Ip","name"=>"local_ip" );
		...
		$this->form[] = ["label"=>"Local Ip","name"=>"local_ip","type"=>"text","required"=>TRUE,"validation"=>"required|min:1|max:255"];
		$this->form[] = ["label"=>"Telegram Bot Id","name"=>"telegram_bot_id","type"=>"select2","required"=>TRUE,"validation"=>"required|string|min:5|max:5000","datatable"=>"telegram_bot,id"];
		$this->form[] = ["label"=>"Telegram Chat Id","name"=>"telegram_chat_id","type"=>"select2","required"=>TRUE,"validation"=>"required|min:1|max:255","datatable"=>"telegram_chat,id"];
		...
		$this->form[] = ["label"=>"Grup Json","name"=>"grup_json","type"=>"textarea","required"=>TRUE,"validation"=>"required|string|min:5|max:5000"];
